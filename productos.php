                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#top" class="active">Productos</a></li>
                ...
                <div class="col-lg-12">
                    <div class="shoppin-cart">
                        ...
                        if (isset($_SESSION['nombre_usuario'])) {
                            ...
                            $usuario = $_SESSION['nombre_usuario'];
                            $verifica = mysqli_query($con, "SELECT * FROM producto ");
                            while ($row = mysqli_fetch_assoc($verifica)) {
                                listaproductos($row['id_producto'], $row['nombre'], $row['precio'], $row['imagen_principal'], $row['cantidad'], $row['fabricante'], $row['origen']);
                            }
                        }
                        ?>
                    </div>
