                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#top" class="active">Registro/Inicio de Sesión</a></li>
                        </ul>
                ...
                <div class="col-sm">
                    <form id="contact" action="" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <fieldset>
                                    <button type="submit" class="btn btn-primary mb-2">CREA TU CUENTA</button>
                                </fieldset>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-sm">
                    <form id="contact" action="" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <fieldset>
                                    <button type="submit" class="btn btn-primary mb-2">INICIA SESIÓN</button>
                                </fieldset>
                            </div>
                        </div>
                    </form>
